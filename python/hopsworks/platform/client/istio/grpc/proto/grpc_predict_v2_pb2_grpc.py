...
import hopsworks.platform.client.istio.grpc.inference_client as inference_client
import hopsworks.platform.client.istio.grpc.proto.grpc_predict_v2_pb2 as grpc__predict__v2__pb2
