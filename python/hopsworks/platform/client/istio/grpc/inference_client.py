...
import grpc
from hopsworks.platform.client.istio.grpc.proto.grpc_predict_v2_pb2_grpc import (
    GRPCInferenceServiceStub,
)
from hopsworks.platform.client.istio.utils.infer_type import InferRequest, InferResponse
