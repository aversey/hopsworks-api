...
if TYPE_CHECKING:
    from hopsworks.fs import feature_view, storage_connector, training_dataset
    from hopsworks.fs.constructor.serving_prepared_statement import (
        ServingPreparedStatement,
    )
    from hopsworks.fs.serving_key import ServingKey
