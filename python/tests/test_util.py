...
class TestUtil:
    ...
    def test_set_model_class_base(self, backend_fixtures):
        ...
        # Act
        model = hsml.util.set_model_class(json)
    ...
    def test_set_model_class_unsupported(self, backend_fixtures):
        ...
        with pytest.raises(ValueError) as e_info:
            hsml.util.set_model_class(json)
    ...
    def test_input_example_to_json_from_numpy(self, mocker, input_example_numpy):
        ...
        # Act
        hsml.util.input_example_to_json(input_example_numpy)
    ...
    def test_input_example_to_json_from_dict(self, mocker, input_example_dict):
        ...
        # Act
        hsml.util.input_example_to_json(input_example_dict)
    ...
    def test_input_example_to_json_from_dataframe(
        ...
        # Act
        hsml.util.input_example_to_json(input_example_dataframe_pandas_dataframe)
    ...
    def test_input_example_to_json_unsupported(self, mocker):
        ...
        # Act
        hsml.util.input_example_to_json(lambda unsupported_type: None)
    ...
    def test_handle_dataframe_input_list(self, input_example_dataframe_list):
        # Act
        json = hsml.util._handle_dataframe_input(input_example_dataframe_list)
    ...
    def test_handle_dataframe_input_unsupported(self):
        ...
        with pytest.raises(TypeError) as e_info:
            hsml.util._handle_dataframe_input(lambda unsupported: None)
    ...
    def test_handle_tensor_input(
        ...
        # Act
        json = hsml.util._handle_tensor_input(input_example_numpy)
    ...
    def test_handle_dict_input(self, input_example_dict):
        # Act
        json = hsml.util._handle_dict_input(input_example_dict)
    ...
    def test_compress_dir(self, mocker):
        ...
        # Act
        path = hsml.util.compress(archive_out_path, archive_name, path_to_archive)
    ...
    def test_decompress(self, mocker):
        ...
        # Act
        path = hsml.util.decompress(archive_file_path, extract_dir)
    ...
    def test_validate_metrics(self, model_metrics):
        # Act
        hsml.util.validate_metrics(model_metrics)
    ...
    def test_validate_metrics_unsupported_type(self, model_metrics_wrong_type):
        # Act
        with pytest.raises(TypeError) as e_info:
            hsml.util.validate_metrics(model_metrics_wrong_type)
    ...
    def test_validate_metrics_unsupported_metric_type(
        ...
        # Act
        with pytest.raises(TypeError) as e_info:
            hsml.util.validate_metrics(model_metrics_wrong_metric_type)
    ...
    def test_validate_metrics_unsupported_metric_value(
        ...
        # Act
        with pytest.raises(ValueError) as e_info:
            hsml.util.validate_metrics(model_metrics_wrong_metric_value)
    ...
    def test_get_predictor_for_model_base(self, mocker, model_base):
        ...
        # Act
        predictor = hsml.util.get_predictor_for_model(model_base)
    ...
    def test_get_predictor_for_model_python(self, mocker, model_python):
        ...
        # Act
        predictor = hsml.util.get_predictor_for_model(model_python)
    ...
    def test_get_predictor_for_model_sklearn(self, mocker, model_sklearn):
        ...
        # Act
        predictor = hsml.util.get_predictor_for_model(model_sklearn)
    ...
    def test_get_predictor_for_model_tensorflow(self, mocker, model_tensorflow):
        ...
        # Act
        predictor = hsml.util.get_predictor_for_model(model_tensorflow)
    ...
    def test_get_predictor_for_model_torch(self, mocker, model_torch):
        ...
        # Act
        predictor = hsml.util.get_predictor_for_model(model_torch)
    ...
    def test_get_predictor_for_model_non_base(self, mocker):
        ...
        # Act
        with pytest.raises(ValueError) as e_info:
            hsml.util.get_predictor_for_model(NonBaseModel())
    ...
    def test_get_hostname_replaced_url(self, mocker):
        ...
        # Act
        url = hsml.util.get_hostname_replaced_url(sub_path)
    ...
    def test_get_members(self):
        ...
        # Act
        members = list(hsml.util.get_members(TEST))
    ...
    def test_get_members_with_prefix(self):
        ...
        # Act
        members = list(hsml.util.get_members(TEST, prefix="TEST"))
    ...
    def test_extract_field_from_json(self, mocker):
        ...
        # Act
        b = hsml.util.extract_field_from_json(json, "b")
    ...
    def test_extract_field_from_json_fields(self, mocker):
        ...
        # Act
        b = hsml.util.extract_field_from_json(json, ["B", "b"])  # alternative fields
    ...
    def test_extract_field_from_json_as_instance_of_str(self, mocker):
        ...
        # Act
        b = hsml.util.extract_field_from_json(json, "b", as_instance_of=str)
    ...
    def test_get_obj_from_json_cls(self, mocker):
        ...
        # Act
        obj = hsml.util.get_obj_from_json(Test(), Test)
    ...
    def test_get_obj_from_json_dict(self, mocker):
        ...
        # Act
        obj = hsml.util.get_obj_from_json({"a": "1"}, Test)
    ...
    def test_get_obj_from_json_dict_default(self, mocker):
        ...
        # Act
        obj = hsml.util.get_obj_from_json({}, Test)
    ...
    def test_get_obj_from_json_unsupported(self, mocker):
        ...
        # Act
        with pytest.raises(ValueError) as e_info:
            hsml.util.get_obj_from_json("UNSUPPORTED", Test)
    ...
    def test_create_async_engine(self, mocker):
        ...
        with patch("asyncio.get_running_loop", side_effect=RuntimeError):
            ...
            with pytest.raises(
                ...
                asyncio.run(hsfs.util.create_async_engine(online_connector, True, 1))
